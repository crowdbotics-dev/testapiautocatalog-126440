...
## Project Structure
    ...
    ├── testapiautocatalog_126440  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_126440`
...
2. Clone this repo and `cd testapiautocatalog_126440`
